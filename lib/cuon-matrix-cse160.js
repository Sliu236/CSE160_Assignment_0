...
class Vector3 {
    ...
    static dot(other1, other2) {
      return other1.elements[0] * other2.elements[0] + other1.elements[1] * other2.elements[1] + other1.elements[2] * other2.elements[2];
    }
    ...
    static cross(other1, other2) {
        ...
        let x = other1.elements;
        let y = other2.elements;
        let v3 = new Vector3(); // Modify this line to calculate cross product between other1 and other2.

        v3.elements[0] = x[1] * y[2] - x[2] * y[1];
        v3.elements[1] = x[2] * y[0] - x[0] * y[2];
        v3.elements[2] = x[0] * y[1] - x[1] * y[0];
